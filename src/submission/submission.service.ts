...
//     const examData = await this.prisma.exam.findUnique({
//       where: {
...
//         FROM "questions"
//         WHERE chapter_id = ${examData.topic_id}
//         ORDER BY RANDOM()
...
//           const questionsData = await this.prisma.$queryRaw<
//             Array<{
//               id: number;
...
//       await this.prisma.submissionQuestions.upsert({
//         where: {
...
//       await this.prisma.submissionQuestions.findMany({
//         where: {
