...
type SchemaType = z.ZodType<Prisma.ExamQuestionsUpdateManyMutationInput>;
export const ExamQuestionsUpdateManyMutationInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
